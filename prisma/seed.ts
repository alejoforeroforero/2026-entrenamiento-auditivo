...
const REPERTOIRE = [
  {
    id: 'ismael-las-caras-lindas-45',
    title: 'Las Caras Lindas',
    artist: 'Ismael Rivera',
    genreId: 'salsa',
    progressionId: 'i-V-iv-V',
    key: 'A',
    mode: Mode.minor,
  ...
  {
    id: 'ismael-el-incomprendido-25',
    title: 'El Incomprendido',
    artist: 'Ismael Rivera',
    genreId: 'salsa',
    progressionId: 'i-VII-VI-V',
    key: 'E',
    mode: Mode.minor,
